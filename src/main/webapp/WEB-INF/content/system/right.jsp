...
<body style="padding-left: 5px">
    ...
    <br>
	<p>轻量:snaker-core.jar大小不超过200K，代码行数不足7000行，强大的扩展支持，不依赖于具体的ORM框架</p>
	<p>简单:表设计简单[仅7张表]，流程组件简单[start/end/task/custom/subprocess/decision/fork/join]</p>
	...
	<br/>
	<h3>资源</h3>
    <p>流程引擎源码(github):<br><a href="https://github.com/snakerflow/snaker-core" target="_blank">https://github.com/snakerflow/snaker-core</a></p>
	<p>演示应用源码(github):<br><a href="https://github.com/snakerflow/snaker-web" target="_blank">https://github.com/snakerflow/snaker-demo</a></p>
	...
	<br>
	<p>流程引擎源码(oscgit):<br><a href="http://git.oschina.net/yuqs/snaker-core" target="_blank">http://git.oschina.net/yuqs/snaker-core</a></p>
	<p>演示应用源码(oscgit):<br><a href="http://git.oschina.net/yuqs/snaker-web" target="_blank">http://git.oschina.net/yuqs/snaker-demo</a></p>
