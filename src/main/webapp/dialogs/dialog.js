function selectCompanyOpen(ctx, e1, e2)
{
	var element1 = document.getElementById(e1);
	var element2 = document.getElementById(e2);
 	var l  = window.showModalDialog(ctx + "/dialogs/selectDialog.jsp"," ","dialogWidth:800px;dialogHeight:540px;center:yes;scrolling:yes");
 	if (l == null )
 	    return;
